...
_COMMANDS=about.o active.o addcom.o addrec.o calc.o cgrep.o cmdinfo.o cml.o\
	  ...
	  followage.o ge.o help.o level.o manual.o permit.o rsn.o setgiv.o\
	  setrec.o showrec.o status.o strawpoll.o submit.o twitter.o uptime.o\
	  wheel.o whitelist.o xp.o
